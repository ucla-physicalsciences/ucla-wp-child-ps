<?php /* Template Name: R-AOS Dynamics & Climate Template */ ?>
<?php get_header(); ?>
<main id="main"> 
    <header class="header" >
...
wp_get_current_user(); if (is_object_in_term($user->ID,'atmospheric-dynamics-and-climate', 'research_field')) {
 echo '<li>'?>
...
foreach ( $users as $user ) {
?><div class="col span_5_of_12"> <?php
wp_get_current_user(); if (is_object_in_term($user->ID,'atmospheric-dynamics-and-climate', 'research_field')) {  echo '<li>'?>
<article class="person-card">
