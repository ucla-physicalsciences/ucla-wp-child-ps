<?php /* Template Name: Seminar Event Listing */ ?>
...
<br>
<h2 class="yellow-side-header">Seminars</h2><br><br>
<p class="lead"> Introductory description of the Seminar Event category </p>
<p>Below you'll find a listing of all the Departement Seminar Events</p>
</div>
</div>
</header>
<div class = "ucla campus">
