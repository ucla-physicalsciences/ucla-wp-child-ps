<?php /* Template Name: News Faculty + Staff Listing */ ?>
...
<br>
<h2 class="yellow-side-header">Faculty + Staff</h2><br><br>
<p class="lead"> Introductory description of the Faculty + Staff News category </p>
<p>Below you'll find a listing of all the news articles with topic Faculty + Staff</p>
</div>
</div>
</header>
<div class = "ucla campus">
