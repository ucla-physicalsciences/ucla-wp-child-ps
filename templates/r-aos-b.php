...
wp_get_current_user(); if (is_object_in_term($user->ID,'biogeochemistry', 'research_field')) {
 echo '<li>'?>
...
foreach ( $users as $user ) {
?><div class="col span_5_of_12"> <?php
wp_get_current_user(); if (is_object_in_term($user->ID,'biogeochemistry', 'research_field')) {  echo '<li>'?>
<article class="person-card">
